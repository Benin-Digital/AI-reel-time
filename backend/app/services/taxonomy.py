...
_SKILLS: dict[str, list[str]] = {
    ...
    "Cybersécurité": ["cybersecurite", "cybersecurity", "securite informatique", "pentest", "securite reseau", "soc", "siem"],
    "API REST": ["api", "rest", "restful", "api rest", "web services", "microservices", "graphql"],
    "Agile": ["agile", "methode agile", "agilite"],
    ...
    "Formation": ["formation", "training", "developpement des competences", "animation de formation"],
    ...
    "Réseaux sociaux": ["reseaux sociaux", "social media", "community management", "community manager", "facebook", "instagram", "linkedin", "tiktok"],
    ...
    "Créativité": ["creativite", "creatif", "innovation", "inventivite", "ideation"],
